...
__attribute__((section("__versions"))) = {
	...
	{ 0x1c170696, __VMLINUX_SYMBOL_STR(device_create_file) },
	{ 0x99826c9f, __VMLINUX_SYMBOL_STR(dev_notice) },
